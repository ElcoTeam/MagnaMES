(function ($) {
    ...
    $.learunindex = {
        ...
        loadMenu: function () {
                ...
                success: function (data) {
                    ...
                    $("#sidebar-menu li a").click(function () {
                        ...
                        if (e.is(".treeview-menu") && e.is(":visible")) {
                            ...
                            //var _height1 = $(window).height() - $("#sidebar-menu >li").position().top - 41;
                            //var _height2 = $("#sidebar-menu li > ul").height() + 10
                            //if (_height2 > _height1) {
                            //    $("#sidebar-menu >li > ul").css({
                            //        overflow: "auto",
                            //        height: _height1
                            //    })
                            //}
            ...
            //$.getJSON("fMenu.aspx", function (result) {             
            ...
            //            }
            //            _html += '<a href="#">'
            //            _html += '<i class="' + row.img + '"></i><span>' + row.menuname + '</span><i class="fa fa-angle-left pull-right"></i>'
            //            _html += '</a>'
            //            var childNodes = $.learunindex.jsonWhere(result, function (v) { return v.parentno == row.menuno });
            //            if (childNodes.length > 0) {
            //                _html += '<ul class="treeview-menu">';
            //                $.each(childNodes, function (i) {
            //                    var subrow = childNodes[i];
            //                    var subchildNodes = $.learunindex.jsonWhere(result, function (v) { return v.parentno == subrow.menuno });
            //                    _html += '<li>';
            //                    if (subchildNodes.length > 0) {
            //                        _html += '<a href="#"><i class="' + subrow.img + '"></i>' + subrow.menuname + '';
            //                        _html += '<i class="fa fa-angle-left pull-right"></i></a>';
